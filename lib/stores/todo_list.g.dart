...
mixin _$TodoList on _TodoList, Store {
  ...
  ObservableList<Todo> get visibleTodos => (_$visibleTodosComputed ??=
      ...
      .value;
  Computed<bool>? _$canRemovedAllCompletedComputed;

  @override
  bool get canRemovedAllCompleted => (_$canRemovedAllCompletedComputed ??=
          Computed<bool>(() => super.canRemovedAllCompleted,
              name: '_TodoList.canRemovedAllCompleted'))
      .value;
...
canRemovedAllCompleted: ${canRemovedAllCompleted},
